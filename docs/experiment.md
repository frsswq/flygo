...
The web viewer lets a human play Black while the frozen graph answers automatically as White, and displays simulated activity generated by FlyGo dynamics, not measured activity from a living fly.
